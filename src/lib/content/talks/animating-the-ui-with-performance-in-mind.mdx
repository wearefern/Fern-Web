---
title: Designing motion without slowing down product workflows
date: Nov 12, 2023
description: A performance-minded view of interface motion, with practical guidance for using animation to clarify workflows without adding friction.
thumbnail: '/images/insights/animating-the-ui-with-performance-in-mind.webp'
tags:
  - interaction
  - performance
  - frontend
